    ...
    <form class="form form--add-lot container <?= $errors ? "form--invalid" : ''; ?>" action="add.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form__container-two">
            <div class="form__item <?= isset($errors["lot-name"]) ? "form__item--invalid" : ""; ?>">
                ...
                <input id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота" value="<?= e(readPOST('lot-name')) ?>">
        ...
        <div class="form__item form__item--wide <?= isset($errors["message"]) ? "form__item--invalid" : ""; ?>">
            ...
            <textarea id="message" name="message" placeholder="Напишите описание лота" value=""><?= e(readPOST('message')) ?></textarea>
        ...
        <div class="form__container-three">
            ...
            <div class="form__item <?= isset($errors["lot-date"]) ? "form__item--invalid" : ""; ?>">
                ...
                <input class="form__input-date" id="lot-date" type="text" name="lot-date" placeholder="Введите дату в формате ГГГГ-ММ-ДД" value="<?= e(readPOST('lot-date')) ?>">
