    ...
    <section class="rates container">
        ...
        <table class="rates__list">
            <?php foreach ($lotsWithMyBets as $lotsWithMyBet): ?>
                ...
                if (!isset($lotsWithMyBet['winner_users_id'])) {$lotsWithMyBet['winner_users_id'] = 0;}
                ...
                <tr class="rates__item <?=$class_item ?>">
                    <td class="rates__info">
                        ...
                        <div>
                            <h3 class="rates__title"><a href="/lot.php?id=<?=$lotsWithMyBet['lot_Id'] ?>"><?=e($lotsWithMyBet['name']) ?></a></h3>


                            <?php if ($text_timer == "Ставка выиграла" || $text_timer == "Торги окончены") : ?> <p> <?=e($lotsWithMyBet['contacts']) ?> </p><?php endif; ?>
                        </div>
                    </td>
